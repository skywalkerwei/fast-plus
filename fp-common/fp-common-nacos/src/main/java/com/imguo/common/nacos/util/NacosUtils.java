package com.imguo.common.nacos.util;
...
public class NacosUtils {
   ...
   */
  public Map<String, Map> getConfig(String dataId, String groupId) {
    ...
    try {
      ...
      Yaml yaml = new Yaml();
      Map<String, Map> map = yaml.load(confStr);
      return map;
   ...
   * @return: boolean
   */
  public boolean publishConfig(String dataId, String groupId, String confMap)
