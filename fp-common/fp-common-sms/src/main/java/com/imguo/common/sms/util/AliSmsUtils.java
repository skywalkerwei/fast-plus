package com.imguo.common.sms.util;
...
import com.imguo.common.sms.properties.AliSmsProperties;
...
public class AliSmsUtils {
  ...
  public void sendSms(String phoneNumber, String templateParam) throws Exception {
    com.aliyun.dysmsapi20170525.Client client =
        createClient(aliSmsProperties.getAccessKeyId(), aliSmsProperties.getAccessKeySecret());
    SendSmsRequest sendSmsRequest =
        new SendSmsRequest()
            .setSignName(aliSmsProperties.getLoginSignName())
